...
/*================================================================================================================================================
                                                                         HEADER
  ==============================================================================================================================================*/
void actionCustomWeatherIcon() {
  String value = Homey.value;
  if (value == "disable") {
    customWeatherIcon = false;
  }
  if (value != "disable") {
    customWeatherIcon = true;
    if (customWeatherIconChoose != value) {
      preferences.putString("weatherIconChoose", value);
      deviceIconChoose = Homey.value;
      deviceIconNumber();
      delay(100);
      epd_poweron();
      epd_clear_area(headerClearIcon);
      epd_draw_image(customWeatherIconArea, (uint8_t *)deviceIconList80[deviceIcon], BLACK_ON_WHITE);
      epd_poweroff();
    }
  }
  paperScreenOnline = true;
...
void actionValueZ1() {
  String value = Homey.value;
  if ( (value.toFloat() == valueZ1.toFloat()) && (typeZ1 == "compare") && (!deepSleepEnable) ) {
    if (displayMode == "horizontal 4") {
      epd_clear_area(clearHigherAreaZ1);
      epd_clear_area(clearLowerAreaZ1);
    }
    if (displayMode == "horizontal 6") {
      epd_clear_area(clearHigherAreaZ1_H6);
      epd_clear_area(clearLowerAreaZ1_H6);
    }
  }
  if (valueZ1 != value) {
    preferences.putString("valueZ1", value);
    if ( (value.toFloat() > valueZ1.toFloat()) && (typeZ1 == "compare") && (displayMode == "horizontal 6") ) {//============================
      if (!deepSleepEnable) {
        epd_clear_area(clearLowerAreaZ1_H6);
      }
      epd_draw_image(higherAreaZ1_H6, (uint8_t *)up_data, BLACK_ON_WHITE);
    }
    if ( (value.toFloat() < valueZ1.toFloat()) && (typeZ1 == "compare") && (displayMode == "horizontal 6") ) {
      if (!deepSleepEnable) {
        epd_clear_area(clearHigherAreaZ1_H6);
      }
      epd_draw_image(lowerAreaZ1_H6, (uint8_t *)down_data, BLACK_ON_WHITE);
    }
    //============================
    if ( (value.toFloat() > valueZ1.toFloat()) && (typeZ1 == "compare") && (displayMode == "horizontal 4") ) {//============================
      if (!deepSleepEnable) {
        epd_clear_area(clearLowerAreaZ1);
      }
      epd_draw_image(higherAreaZ1, (uint8_t *)up_data, BLACK_ON_WHITE);
    }
    if ( (value.toFloat() < valueZ1.toFloat()) && (typeZ1 == "compare") && (displayMode == "horizontal 4") ) {
      if (!deepSleepEnable) {
        epd_clear_area(clearHigherAreaZ1);
      }
      epd_draw_image(lowerAreaZ1, (uint8_t *)down_data, BLACK_ON_WHITE);
    }
    valueZ1 = value;//========================================================================================================================
    value2Z1 = value;
...
void actionValueZ2() {
  String value = Homey.value;
  if ( (value.toFloat() == valueZ2.toFloat()) && (typeZ2 == "compare") && (!deepSleepEnable) ) {
    if (displayMode == "horizontal 4") {
      epd_clear_area(clearHigherAreaZ2);
      epd_clear_area(clearLowerAreaZ2);
    }
    if (displayMode == "horizontal 6") {
      epd_clear_area(clearHigherAreaZ2_H6);
      epd_clear_area(clearLowerAreaZ2_H6);
    }
  }
  if (valueZ2 != value) {
    preferences.putString("valueZ2", value);
    if ( (value.toFloat() > valueZ2.toFloat()) && (typeZ2 == "compare") && (displayMode == "horizontal 6") ) {//============================
      if (!deepSleepEnable) {
        epd_clear_area(clearLowerAreaZ2_H6);
      }
      epd_draw_image(higherAreaZ2_H6, (uint8_t *)up_data, BLACK_ON_WHITE);
    }
    if ( (value.toFloat() < valueZ2.toFloat()) && (typeZ2 == "compare") && (displayMode == "horizontal 6") ) {
      if (!deepSleepEnable) {
        epd_clear_area(clearHigherAreaZ2_H6);
      }
      epd_draw_image(lowerAreaZ2_H6, (uint8_t *)down_data, BLACK_ON_WHITE);
    }
    //============================
    if ( (value.toFloat() > valueZ2.toFloat()) && (typeZ2 == "compare") && (displayMode == "horizontal 4") ) {//============================
      if (!deepSleepEnable) {
        epd_clear_area(clearLowerAreaZ2);
      }
      epd_draw_image(higherAreaZ2, (uint8_t *)up_data, BLACK_ON_WHITE);
    }
    if ( (value.toFloat() < valueZ2.toFloat()) && (typeZ2 == "compare") && (displayMode == "horizontal 4") ) {
      if (!deepSleepEnable) {
        epd_clear_area(clearHigherAreaZ2);
      }
      epd_draw_image(lowerAreaZ2, (uint8_t *)down_data, BLACK_ON_WHITE);
    }
    valueZ2 = value;//========================================================================================================================
    value2Z2 = value;
...
void actionValueZ3() {
  String value = Homey.value;
  if ( (value.toFloat() == valueZ3.toFloat()) && (typeZ3 == "compare") && (!deepSleepEnable) ) {
    if (displayMode == "horizontal 4") {
      epd_clear_area(clearHigherAreaZ3);
      epd_clear_area(clearLowerAreaZ3);
    }
    if (displayMode == "horizontal 6") {
      epd_clear_area(clearHigherAreaZ3_H6);
      epd_clear_area(clearLowerAreaZ3_H6);
    }
  }
  if (valueZ3 != value) {
    preferences.putString("valueZ3", value);
    if ( (value.toFloat() > valueZ3.toFloat()) && (typeZ3 == "compare") && (displayMode == "horizontal 6") ) {//============================
      if (!deepSleepEnable) {
        epd_clear_area(clearLowerAreaZ3_H6);
      }
      epd_draw_image(higherAreaZ3_H6, (uint8_t *)up_data, BLACK_ON_WHITE);
    }
    if ( (value.toFloat() < valueZ3.toFloat()) && (typeZ3 == "compare") && (displayMode == "horizontal 6") ) {
      if (!deepSleepEnable) {
        epd_clear_area(clearHigherAreaZ3_H6);
      }
      epd_draw_image(lowerAreaZ3_H6, (uint8_t *)down_data, BLACK_ON_WHITE);
    }
    //============================
    if ( (value.toFloat() > valueZ3.toFloat()) && (typeZ3 == "compare") && (displayMode == "horizontal 4") ) {//============================
      if (!deepSleepEnable) {
        epd_clear_area(clearLowerAreaZ3);
      }
      epd_draw_image(higherAreaZ3, (uint8_t *)up_data, BLACK_ON_WHITE);
    }
    if ( (value.toFloat() < valueZ3.toFloat()) && (typeZ3 == "compare") && (displayMode == "horizontal 4") ) {
      if (!deepSleepEnable) {
        epd_clear_area(clearHigherAreaZ3);
      }
      epd_draw_image(lowerAreaZ3, (uint8_t *)down_data, BLACK_ON_WHITE);
    }
    valueZ3 = value;//========================================================================================================================
    value2Z3 = value;
...
void actionValueZ4() {
  String value = Homey.value;
  if ( (value.toFloat() == valueZ4.toFloat()) && (typeZ4 == "compare") && (!deepSleepEnable) ) {
    if (displayMode == "horizontal 4") {
      epd_clear_area(clearHigherAreaZ4);
      epd_clear_area(clearLowerAreaZ4);
    }
    if (displayMode == "horizontal 6") {
      epd_clear_area(clearHigherAreaZ4_H6);
      epd_clear_area(clearLowerAreaZ4_H6);
    }
  }
  if (valueZ4 != value) {
    preferences.putString("valueZ4", value);
    if ( (value.toFloat() > valueZ4.toFloat()) && (typeZ4 == "compare") && (displayMode == "horizontal 6") ) {//============================
      if (!deepSleepEnable) {
        epd_clear_area(clearLowerAreaZ4_H6);
      }
      epd_draw_image(higherAreaZ4_H6, (uint8_t *)up_data, BLACK_ON_WHITE);
    }
    if ( (value.toFloat() < valueZ4.toFloat()) && (typeZ4 == "compare") && (displayMode == "horizontal 6") ) {
      if (!deepSleepEnable) {
        epd_clear_area(clearHigherAreaZ4_H6);
      }
      epd_draw_image(lowerAreaZ4_H6, (uint8_t *)down_data, BLACK_ON_WHITE);
    }
    //============================
    if ( (value.toFloat() > valueZ4.toFloat()) && (typeZ4 == "compare") && (displayMode == "horizontal 4") ) {//============================
      if (!deepSleepEnable) {
        epd_clear_area(clearLowerAreaZ4);
      }
      epd_draw_image(higherAreaZ4, (uint8_t *)up_data, BLACK_ON_WHITE);
    }
    if ( (value.toFloat() < valueZ4.toFloat()) && (typeZ4 == "compare") && (displayMode == "horizontal 4") ) {
      if (!deepSleepEnable) {
        epd_clear_area(clearHigherAreaZ4);
      }
      epd_draw_image(lowerAreaZ4, (uint8_t *)down_data, BLACK_ON_WHITE);
    }
    valueZ4 = value;//========================================================================================================================
    value2Z4 = value;
...
void actionValueZ5() {
  String value = Homey.value;
  if ( (value.toFloat() == valueZ5.toFloat()) && (typeZ5 == "compare") && (!deepSleepEnable) ) {
    if (displayMode == "horizontal 6") {
      epd_clear_area(clearHigherAreaZ5_H6);
      epd_clear_area(clearLowerAreaZ5_H6);
    }
  }
  if (valueZ5 != value) {
    preferences.putString("valueZ5", value);
    if ( (value.toFloat() > valueZ5.toFloat()) && (typeZ5 == "compare") && (displayMode == "horizontal 6") ) {//============================
      if (!deepSleepEnable) {
        epd_clear_area(clearLowerAreaZ5_H6);
      }
      epd_draw_image(higherAreaZ5_H6, (uint8_t *)up_data, BLACK_ON_WHITE);
    }
    if ( (value.toFloat() < valueZ5.toFloat()) && (typeZ5 == "compare") && (displayMode == "horizontal 6") ) {
      if (!deepSleepEnable) {
        epd_clear_area(clearHigherAreaZ5_H6);
      }
      epd_draw_image(lowerAreaZ5_H6, (uint8_t *)down_data, BLACK_ON_WHITE);
    }
    valueZ5 = value;//========================================================================================================================
    value2Z5 = value;
...
void actionValueZ6() {
  String value = Homey.value;
  if ( (value.toFloat() == valueZ6.toFloat()) && (typeZ6 == "compare") && (!deepSleepEnable) ) {
    if (displayMode == "horizontal 6") {
      epd_clear_area(clearHigherAreaZ6_H6);
      epd_clear_area(clearLowerAreaZ6_H6);
    }
  }
  if (valueZ6 != value) {
    preferences.putString("valueZ6", value);
    if ( (value.toFloat() > valueZ6.toFloat()) && (typeZ6 == "compare") && (displayMode == "horizontal 6") ) {//============================
      if (!deepSleepEnable) {
        epd_clear_area(clearLowerAreaZ6_H6);
      }
      epd_draw_image(higherAreaZ6_H6, (uint8_t *)up_data, BLACK_ON_WHITE);
    }
    if ( (value.toFloat() < valueZ6.toFloat()) && (typeZ6 == "compare") && (displayMode == "horizontal 6") ) {
      if (!deepSleepEnable) {
        epd_clear_area(clearHigherAreaZ6_H6);
      }
      epd_draw_image(lowerAreaZ6_H6, (uint8_t *)down_data, BLACK_ON_WHITE);
    }
    valueZ6 = value;//========================================================================================================================
    value2Z6 = value;
