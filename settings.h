...
const uint8_t *deviceIconList[] = {door_data, garageDoor_data, gate_data, humidity_data, light_data, logo_data,
                                   ...
                                   waterSensor_data, waterSensor2_data, wifi_data, wireless_data, printer_data, lux_data, dollar_data, euro_data, lightbolt_data,
                                   washingMachine_data, weather_data, wind_data, openEnvelope_data, closeEnvelope_data
                                  };
...
const uint8_t *deviceIconList80[] = {door80_data, garageDoor80_data, gate80_data, humidity80_data, light80_data, logo80_data,
                                     ...
                                     washingMachine80_data, weather80_data, wind80_data, openEnvelope80_data, closeEnvelope80_data
                                    };
