void setLanguage() {
  ...
  if (lang == "FR") {
    ...
    if (displayMode == "horizontal 4") {
      ERROR_COUNTER = String(counter) + "/16 actions transmises par Homey. Vérifiez vos flow!";
    }
    if (displayMode == "horizontal 6") {
      ERROR_COUNTER = String(counter) + " /22 actions transmises par Homey. Vérifiez vos flow!";
    }
  ...
  if (lang == "EN") {
    ...
    if (displayMode == "horizontal 4") {
      ERROR_COUNTER = String(counter) + "/16 sended from Homey. Check your flow!";
    }
    if (displayMode == "horizontal 6") {
      ERROR_COUNTER = String(counter) + " /16 sended from Homey. Check your flow!";
    }
